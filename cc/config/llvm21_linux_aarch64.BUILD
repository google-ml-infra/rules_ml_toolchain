...
cc_toolchain_import(
    name = "rt_tsan",
    additional_libs = glob([
        "lib/clang/{clang_version}/lib/aarch64-unknown-linux-gnu/libclang_rt.tsan*".format(clang_version = CLANG_VERSION),
    ]),
    visibility = ["//visibility:public"],
)
...
cc_toolchain_import(
    name = "rt_ubsan",
    additional_libs = glob([
        "lib/clang/{clang_version}/lib/aarch64-unknown-linux-gnu/libclang_rt.ubsan*".format(clang_version = CLANG_VERSION),
    ]),
    visibility = ["//visibility:public"],
)
