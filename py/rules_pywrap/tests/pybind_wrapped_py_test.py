...
import unittest
import os
from py.rules_pywrap.tests import pybind_wrapped as regular
from py.rules_pywrap.tests import pybind_wrapped_copy as regular_copy
import py.rules_pywrap.tests.pybind_wrapped
import py.rules_pywrap.tests.pybind_wrapped_copy
from py.rules_pywrap.tests.pybind_wrapped import _EXTRA_SYMBOL as REGULAR_EXTRA_SYMBOL
from py.rules_pywrap.tests.pybind_wrapped_copy import _EXTRA_SYMBOL as REGULAR_COPY_EXTRA_SYMBOL
from py.rules_pywrap.tests.pybind_wrapped.sub import second_func as sub_second_func
import py.rules_pywrap.tests.pybind_wrapped.sub
from py.rules_pywrap.tests.pybind_wrapped.sub._sub_private import *
from py.rules_pywrap.tests.pybind_wrapped.sub._sub_private import _sub_private_private_func
from py.rules_pywrap.tests.sub_pybind.relative_wrapped_import_lib import call_nested_pyind_func
from py.rules_pywrap.tests.sub_pybind.relative_wrapped_import_lib import sub_sub_private_func
...
class PybindWrappedTest(unittest.TestCase):
  ...
  def test_pybind_first(self):
    ...
    print("2: py.rules_pywrap.tests.pybind_wrapped.second_func")
    self.assertEqual(py.rules_pywrap.tests.pybind_wrapped.second_func(1), 2)
    print("3: regular.third_func")
    self.assertEqual(regular.third_func(1), 1)
    print("4: py.rules_pywrap.tests.pybind_wrapped_copy.first_func")
    self.assertEqual(py.rules_pywrap.tests.pybind_wrapped_copy.first_func(1), 4)
    ...
    self.assertEqual(py.rules_pywrap.tests.pybind_wrapped.sub.second_func(1), 6)
    self.assertEqual(py.rules_pywrap.tests.pybind_wrapped.sub._sub_private.sub_sub_func(3), 6)
